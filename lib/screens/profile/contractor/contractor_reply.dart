...
class ContractorReplyScreen extends ConsumerStatefulWidget {
  final String inquiryId;
  final EnquiryDetails details;

  const ContractorReplyScreen(
      {super.key, required this.inquiryId, required this.details});


  @override
  ConsumerState<ContractorReplyScreen> createState() =>
      _ContractorReplyScreenState();
}

class _ContractorReplyScreenState extends ConsumerState<ContractorReplyScreen> {
